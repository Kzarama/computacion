...
public class TsscTopic implements Serializable {
	...
	@OneToMany(mappedBy = "tsscTopic")
	@JsonIgnore
	private List<TsscTimecontrol> tsscTimesControls;

	public List<TsscTimecontrol> getTsscTimesControls() {
		return tsscTimesControls;
	}

	public void setTsscTimesControls(List<TsscTimecontrol> tsscTimesControls) {
		this.tsscTimesControls = tsscTimesControls;
	}
